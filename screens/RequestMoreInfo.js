...
import { ScrollView, TextInput, StyleSheet, Image, Text, TouchableOpacity, StatusBar, View ,Platform} from 'react-native';
...
export default function RequestMoreInfo(Props) {
...
RequestMoreInfo.navigationOptions = ({navigation}) => ({
  headerTitle: (
    'Request More info'
  ),
  headerTintColor: '#fff',
